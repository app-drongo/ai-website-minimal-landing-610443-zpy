...
const DEFAULT_HERO = {
  badge: 'New: Minimal Design System',
  title: 'Launch your startup with',
  titleHighlight: 'minimal perfection',
  description:
    'Clean, modern landing pages that convert visitors into customers. Perfect for startups, SaaS products, and digital entrepreneurs who value simplicity.',
  features: [
  ...
  imageAlt: 'Minimal startup dashboard interface',
  statsLabel1: 'Conversion Rate',
  statsValue1: '12.5% avg',
  statsLabel2: 'Load Time',
  statsValue2: '< 1.2s',
} as const;
