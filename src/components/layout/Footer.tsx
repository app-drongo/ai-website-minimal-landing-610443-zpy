...
const DEFAULT_FOOTER = {
  logoText: 'Minimal Landing',
  companyDescription:
    'Empowering businesses with beautiful, conversion-focused landing pages. Trusted by over 10,000 companies worldwide to create stunning web experiences that drive results.',
  contactEmail: 'hello@minimallanding.com',
  contactPhone: '+1 (555) 847-2910',
  contactAddress: '2847 Innovation Drive, San Francisco, CA 94107',
  newsletterTitle: 'Weekly Design Insights',
  newsletterPlaceholder: 'Enter your email address',
  newsletterDisclaimer:
    'Get weekly tips on landing page optimization and design trends. Unsubscribe anytime.',
  section1Title: 'Platform',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Minimal Landing. All rights reserved.',
  madeWithText: 'with passion in San Francisco',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/minimallanding',
  social2Href: 'https://facebook.com/minimallanding',
  social3Href: 'https://instagram.com/minimallanding',
  social4Href: 'https://linkedin.com/company/minimallanding',
  social5Href: 'https://github.com/minimallanding',
} as const;
  ...
  const footerSections = [
    {
      ...
      links: [
        { name: 'Template Library', href: '/templates', editableId: 'link-footer-templates' },
        ...
        { name: 'Custom Domains', href: '/domains', editableId: 'link-footer-domains' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Design Blog', href: '/blog', editableId: 'link-footer-blog' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Design Academy', href: '/academy', editableId: 'link-footer-academy' },
        ...
        { name: 'API Documentation', href: '/api-docs', editableId: 'link-footer-api-docs' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Security', href: '/security', editableId: 'link-footer-security' },
        {
          ...
          editableId: 'link-footer-data-processing',
        },
      ],
    },
  ];
